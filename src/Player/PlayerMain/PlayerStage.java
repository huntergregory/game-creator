...
//        }
    ...
    public void start(Stage stage) {
        ...
        enemy.objectLogic = "object.addComponent(" + "new MotionComponent('0', '0', '.5', '.5', '0', '0.'), new HealthComponent('100', '100'), " +
                "new ImpassableComponent('true'), new LogicComponent('manager.call(\"Patrol\", instance, (List<List<Double>>)Arrays.asList(Arrays.asList((Double)0.0, (Double)50.0), Arrays.asList((Double)200.0, (Double)50.0),  Arrays.asList((Double)400.0, (Double)50.0)));'))";
        //enemy.objectLogic = "object.addComponent(" + "new MotionComponent('0', '0', '.5', '.5', '0', '0.'), new HealthComponent('100', '100'), " +
...
<<<<<<< HEAD
        ...
        load("C:\\Users\\DNTDN\\Documents\\School Files\\Spring 2019\\CS 308\\voogasalad_crackingopen\\res\\DLiu.game");
=======
>>>>>>> ac73cab8a1d864ca81a255c5a6ae47167f4024dc
    }
