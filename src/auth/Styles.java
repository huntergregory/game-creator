...
public class Styles {
    ...
    public static String LEFT_PANE_STYLE = "-fx-background-color : #333333;" +
            "-fx-effect: dropshadow(three-pass-box, rgba(0,0,0,0.5), 10, 0, 0, 0);" +
            "-fx-border-radius: 0 15 15 0;" +
            "-fx-background-radius: 0 15 15 0;";
    public static String RIGHT_PANE_STYLE = "-fx-background-color : #333333;" +
            "-fx-effect: dropshadow(three-pass-box, rgba(0,0,0,0.5), 10, 0, 0, 0);" +
    ...
    public static String CENTRE_PANE_STYLE = "-fx-background-color : #333333;" +
            "-fx-effect: dropshadow(three-pass-box, rgba(0,0,0,0.5), 10, 0, 0, 0);" +
            "-fx-border-radius: 15 15 15 15;" +
            "-fx-background-radius: 15 15 15 15;";
    public static String TOP_PANE_STYLE = "-fx-background-color : #333333;" +
            "-fx-effect: dropshadow(three-pass-box, rgba(0,0,0,0.5), 10, 0, 0, 0);" +
            "-fx-border-radius: 0 0 15 15;" +
            "-fx-background-radius: 0 0 15 15;";
    public static String CANVAS_STYLE = "-fx-background-color : #ffffff;" +
